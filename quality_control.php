...
if (isset ($_GET['delid'])) {
    ...
    echo "<script>window.location.href = 'quality_control.php'</script>";
}
?>
<!DOCTYPE html>
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-7" align="right">
                            ...
                            <a href="quality_control.php" title="تحديث الصفحة">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                        $ret = mysqli_query($con, "select * from tblquality");
                        $cnt = 1;
                            ...
                            <td class="hidden-column">
                                ...
                                <a href="edit.php?editid=<?php echo htmlentities($row['ID']); ?>" class="edit"
                                    title="إضافة" data-toggle="tooltip"><img src="edit_icon.svg" alt="Edit Icon"
                                        class="edit-icon"></a>
                                <a href="quality_control.php?delid=<?php echo ($row['ID']); ?>&&ppic=<?php echo $row['ProfilePic']; ?>"
