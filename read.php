                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7" align="right">
                            <a href="edit.php?editid=<?php echo htmlentities($row['ID']); ?>"
                                class="btn btn-primary"><span>تحرير تفاصيل الملف</span></a>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered"
                    ...
                    <tbody>
                        <tr>
                            <th width="200">ملف</th>
                            <td>
                                <?php if (pathinfo($row['ProfilePic'], PATHINFO_EXTENSION) == 'pdf'): ?>
                                <img src="pdf_icon.png" width="80" height="80" alt="PDF Icon">
                                <?php else: ?>
